...
class AxisY(pg.AxisItem):
    ...
    def drawPicture(self, p, axisSpec, tickSpecs, textSpecs):
        ...
        if self.mouse_scene is not None:
            ...
            p.fillRect(rect.adjusted(-100, 0, 0, 0), QtGui.QColor(100, 100, 250, 220))
...
class PlotWidget(pg.PlotWidget):
    def __init__(self, *args, **kwargs):
        ...
        # ------------------------------- axis ------------------------------- #
        self.axix_left = AxisY('left')
        self.plotItem.setAxisItems({'left':self.axix_left})
        # ------------------------------ signal ------------------------------ #
