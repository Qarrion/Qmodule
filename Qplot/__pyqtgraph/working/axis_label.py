    ...
    def drawPicture(self, p, axisSpec, tickSpecs, textSpecs):
        ...
        for rect, flags, text in textSpecs:
            if "특정 조건":  # 여기에 특정 조건을 추가
                p.setBrush(pg.mkBrush('b'))  # 배경색 설정
                p.drawRect(rect)  # 텍스트 배경 그리기
...
class  PlotWidget(pg.PlotWidget):
    ...
    def mouseMoveEvent(self, event):
        ...
        # print(self.axis_l._strings)
        # print(self.axis_l._values)
        # print(self.axis_l._strings)
        # new_ticks = list(zip(self.axis_l._values, self.axis_l._strings))
        # print(new_ticks)
        # new_ticks.append((y_value, f"{y_value:2f}"))
        # print(new_ticks)
        # print(self.axis_l._v)
        # new_ticks = old_ticks + []
